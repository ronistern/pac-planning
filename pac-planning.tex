...
that first learns a partial model from the given trajectories and then uses conformant planning
to generate a plan that is guaranteed to reach the goal. 

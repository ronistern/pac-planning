...
\begin{document}
	...
	arbitrary. Even if $D(T|s_{\mathcal{I}},s_{\mathcal{G}})$ produces a deterministic outcome $T(s_{\mathcal{I}},s_{\mathcal{G}})$, this
	still captures, for example, the distribution of trajectories obtained
	by running some (unknown, sophisticated) planning algorithm on input $(s_{\mathcal{I}},s_{\mathcal{G}})$.
	It also captures a nondeterministic, adversarial choice of trajectory $T(s_{\mathcal{I}},s_{\mathcal{G}})$ to 
